...
const p5 = new Producto (5,"Chorizo Vegano", 750, "Hecho a base de harina de soja, no poseen conservantes, adictivos ni quimicos industriales.", 3, "../Img/Chorizo vegano (0).jpeg")
const p6 = new Producto (6,"Seitan Vegano", 750, "Hecho a base de harina de trigo fortificada con gluten y harina de soja, no poseen conservantes, adictivos ni quimicos industriales.", 4, "../Img/Seitan (2).jpeg")
