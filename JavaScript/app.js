...
const p5 = new Producto (5,"Chorizo Vegano", 750, "Hecho a base de harina de soja, no poseen conservantes, adictivos ni quimicos industriales.", 3, "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQymIEiQ13MqFtL7UC3ihnFhZpzOJHXiRlrtg&usqp=CAU")
const p6 = new Producto (6,"Seitan Vegano", 750, "Hecho a base de harina de trigo fortificada con gluten y harina de soja, no poseen conservantes, adictivos ni quimicos industriales.", 4, "https://res.cloudinary.com/dokddymx6/image/upload/QkRtNC4qWYQzfmbucK8bmdXk")
